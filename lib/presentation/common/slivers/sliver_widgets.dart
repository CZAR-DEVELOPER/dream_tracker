...
import '../presentation_common.dart';
...
class CustomSliverStickyBar extends StatelessWidget {
  ...
  const CustomSliverStickyBar({Key? key, required this.child, this.toolbarHeight = kToolbarHeight, this.contentPadding = const EdgeInsets.all(0)})
      : super(key: key);
